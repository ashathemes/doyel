...
function doyel_scripts() {
	...
	wp_enqueue_style( 'doyel-default-block', get_template_directory_uri() . '/assets/css/default-block.css', array(), _S_VERSION, 'all');
	wp_enqueue_style( 'doyel-style', get_template_directory_uri() . '/assets/css/doyel-style.css', array(), '1.0.0', 'all');
	wp_enqueue_style( 'doyel-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( 'doyel-script', get_template_directory_uri() . '/assets/js/doyel-script.js', array('jquery'), _S_VERSION, true );
